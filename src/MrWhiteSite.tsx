...
`;
  ...
  const Nav = useMemo(() => (
    ...
    >
     ...
     <nav className="flex items-center gap-6 text-base md:text-lg font-semibold" style={{ fontFamily: "'Aboreto', serif" }}>
  <a href="#gallery" className="text-white hover:opacity-80 transition">Galéria</a>
  <a href="#pricing" className="text-white hover:opacity-80 transition">Árlista</a>
</nav>
      </div>
    </header>
  ), []);
